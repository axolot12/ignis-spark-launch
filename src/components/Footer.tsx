...
const Footer = () => (
  <footer className="relative py-12 px-4 border-t border-border/30">
    <div className="max-w-4xl mx-auto text-center">
      <img src={logo} alt="IgnisLauncher" className="w-10 h-10 mx-auto mb-4 opacity-60 hover:opacity-100 hover:scale-110 transition-all duration-300" width={40} height={40} />
